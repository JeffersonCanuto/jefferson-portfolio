    ...
    items: [
        {
            ...
            attributions: [
                {
                    index: 1,
                    title: "Implementation of Dashboards to monitor IPv4 and IPv6 data traffic collected from CDN distributors."
                },
                {
                    index: 2,
                ...
                {
                    index: 6,
                    title: "Technologies: JavaScript | HTML5 | CSS3 | React.js | Chart.js | Redux | Python | Django REST | PostgreSQL | Docker | Git | Linux"
                }
            ]
        },
        {
            index: 2,
            description: "In 2021, I joined Sidia as a Front-end Software Engineer working with both Web and Android. FYI, Sidia is Samsung Electronics' R&D \
            ...
            attributions: [
                {
                    index: 1,
                    title: "Principal Front-end Engineer and Technical Leader on Automation Team (Tools: PLM Reporter, TRO.IA and PLMN/MVNO)."
                },
                {
                    index: 2,
                    title: "Project Leader for the implementation/delivery of STIR/Shaken and RCD solutions in Brazil from Samsung side."
                },
                {
                    index: 3,
                    title: "Bugfixes, including Android log analysis from App to Framework layer, for Samsung Products."
                },
                {
                    index: 4,
                    title: "Management and implementation of LATAM telephony operator requirements for Samsung Products."
                },
                {
                    index: 5,
                    title: "Technologies: JavaScript | HTML5 | CSS3 | React.js | Chart.js | Redux/ContextAPI | Material UI | Python | Django REST | PostgreSQL | Android (Java) | QuickBuild | Docker | Git | P4V | Swarm | Linux | Agile (Scrum/Kanban)"
                }
            ]
        }
    ]
